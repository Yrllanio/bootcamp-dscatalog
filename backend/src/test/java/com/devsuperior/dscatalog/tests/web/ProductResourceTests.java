...
public class ProductResourceTests {
	...
	void setUP() throws Exception {
		...
		newProductDTO = ProductFactory.creatProductDTO(null);
		existingProductDTO = ProductFactory.creatProductDTO(existingId);
	...
	@Test
	public void insertShouldReturnUnprocessableEntityWhenNegatiPrice() throws Exception{
